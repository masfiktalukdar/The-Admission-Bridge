...
export default function Home() {
  ...
  const [applicationModalData, setApplicationModalData] =
  ...
  const filteredUniversities = useMemo(() => {
    return universities.filter((uni) => {
      const matchesQuery = uni.name
        .toLowerCase()
        .includes(filterState.query.toLowerCase());
      const matchesCountry = filterState.country
        ? uni.country === filterState.country
        : true;
      const matchesDegree = filterState.degree
        ? uni.degree_level === filterState.degree
        : true;
  ...
  const selectedForCompare = universities.filter((u) =>
            ...
            <aside className="w-full lg:w-72 shrink-0 space-y-6">
              ...
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200 sticky top-24">
                ...
                <div className="mt-6 pt-6 border-t border-gray-100">
                  <TuitionSlider
                    value={filterState.maxTuition}
                    onChange={(v) => handleSearchUpdate("maxTuition", v)}
                  />
                </div>
                ...
                <div className="mt-4 bg-blue-50 p-3 rounded-lg flex gap-3 items-start">
                  ...
                  <p className="text-xs text-blue-700 leading-relaxed">
                    Adjusting these sliders updates your eligibility status on
                    all university cards in real-time.
                  </p>
                </div>
              </div>
            </aside>
              ...
              {loading ? (
                ...
                <div className="text-center py-24 bg-white rounded-3xl border-2 border-dashed border-gray-200 flex flex-col items-center">
                  ...
                  <p className="mt-2 text-gray-500 max-w-xs mx-auto">
                    Try adjusting your tuition slider or broadening your search
                    filters.
                  </p>
                  <button
