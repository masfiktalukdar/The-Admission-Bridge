...
export const AnimatedHero = ({ onSearch }: AnimatedHeroProps) => {
  ...
  return (
    <div className="relative min-h-[600px] lg:h-[85vh] bg-indigo-950 text-white overflow-hidden flex items-center justify-center">
      <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1523050854058-8df90110c9f1?auto=format&fit=crop&q=80')] bg-cover bg-center">
        <div className="absolute inset-0 bg-gradient-to-r from-indigo-950/95 via-indigo-900/90 to-purple-900/80 backdrop-blur-[2px]" />
      </div>
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center">
        ...
        >
          ...
          <motion.p variants={itemVariants} className="max-w-2xl mx-auto text-lg md:text-xl text-indigo-100/80 mb-12 leading-relaxed">
            Stop guessing. Start applying. Compare tuition, check real-time eligibility based on your scores, and fast-track your application today.
          </motion.p>
          ...
          >
            ...
            <div className="flex-1 relative group">
              ...
              >
                <option value="" className="bg-indigo-900 text-white">All Countries</option>
                <option value="USA" className="bg-indigo-900 text-white">USA</option>
                <option value="UK" className="bg-indigo-900 text-white">UK</option>
                <option value="Canada" className="bg-indigo-900 text-white">Canada</option>
                <option value="Australia" className="bg-indigo-900 text-white">Australia</option>
                <option value="Germany" className="bg-indigo-900 text-white">Germany</option>
                <option value="Singapore" className="bg-indigo-900 text-white">Singapore</option>
                <option value="Switzerland" className="bg-indigo-900 text-white">Switzerland</option>
              </select>
            </div>
            ...
            <div className="flex-1 relative group">
              ...
              >
                <option value="" className="bg-indigo-900 text-white">All Degrees</option>
                <option value="Bachelors" className="bg-indigo-900 text-white">Bachelors</option>
                <option value="Masters" className="bg-indigo-900 text-white">Masters</option>
                <option value="PhD" className="bg-indigo-900 text-white">PhD</option>
              </select>
            </div>
